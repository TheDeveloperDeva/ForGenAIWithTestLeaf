...
export const DEFAULT_PROMPTS = {
  ...
  SELENIUM_CSHARP_PAGE_ONLY: `
    ...
    - Use Selenium WebDriver compatible imports.
  ...
  /**
   * Cucumber with Selenium C# Step Definitions
   */
  CUCUMBER_WITH_SELENIUM_CSHARP_STEPS: `
    Instructions:
    - Generate BOTH:
      1. A Cucumber .feature file.
      2. A C# step definition class for Selenium WebDriver.
    ...
    public class LoginStepDefinitions
    {
        ...
        {
            var el = wait.Until(d => d.FindElement(By.Id("username")));
        ...
        {
            var el = wait.Until(d => d.FindElement(By.Id("password")));
        ...
        {
            var success = wait.Until(d => d.FindElement(By.ClassName("success")));
    ...
    Persona:
    - Audience: BDD testers who need feature files and C# step definitions.

    Output Format:
    - Feature file in a \`\`\`gherkin\`\`\` block.
    - Step definitions in a \`\`\`csharp\`\`\` block.
  ...
  /**
   * Cucumber with Selenium Java Step Definitions
   */
  CUCUMBER_WITH_SELENIUM_JAVA_STEPS: `
    Instructions:
    - Generate BOTH:
